...
public class CharacterControllerMovable : MonoBehaviour
{
	...
	void Update()
	{
		...
		{
			DoJump();
		} else if (_canDounbleJump && Input.GetButtonDown("Jump")) {
			DoJump();
	...
	public void DoAttack()
	{
		...
		{
			_isAttacking = true;
			StartCoroutine((IEnumerator) AttackCourotine());
	...
	public IEnumerable AttackCourotine()
	{
		Debug.Log("Waiting for seconds: " + _isAttacking);
